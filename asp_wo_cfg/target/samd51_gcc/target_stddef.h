 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_stddef.h 2693 2015-11-04 03:55:57Z ertl-honda $
 */

/*
 *  t_stddef.hのチップ依存部（SAMD51用）
 *
...
#else /* ARDUINO_PASS */
#include "../asp_wo_cfg/arch/gcc/tool_stddef.h"
#endif /* ARDUINO_PASS */
...
#else /* ARDUINO_PASS */
#include "../asp_wo_cfg/arch/arm_m_gcc/common/core_stddef.h"
#endif /* ARDUINO_PASS */
