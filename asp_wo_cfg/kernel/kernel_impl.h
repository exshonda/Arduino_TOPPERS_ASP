 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: kernel_impl.h 63 2013-10-18 22:26:53Z ertl-hiro $
 */
...
#ifndef TARGET_INTATR
#define TARGET_INTATR		0U		/* ターゲット定義の割込み要求ライン属性 */
#endif /* TARGET_INTATR */
...
#ifndef TARGET_INHATR
#define TARGET_INHATR		0U		/* ターゲット定義の割込みハンドラ属性 */
#endif /* TARGET_INHATR */

#ifndef TARGET_EXCATR
#define TARGET_EXCATR		0U		/* ターゲット定義の割込みハンドラ属性 */
#endif /* TARGET_EXCATR */
 ...
 *  初期化処理（アプリケーションで用意）
 */
extern void	inirtn(void);

/*
 *  終了処理（アプリケーションで用意）
 */
extern void	terrtn(void);
