 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: alarm.c 49 2012-09-06 04:41:53Z ertl-hiro $
 */
...
#ifndef LOG_CRE_ALM_ENTER
#define LOG_CRE_ALM_ENTER(almid, pk_calm)
#endif /* LOG_CRE_ALM_ENTER */

#ifndef LOG_CRE_ALM_LEAVE
#define LOG_CRE_ALM_LEAVE(ercd)
#endif /* LOG_CRE_ALM_LEAVE */
...
sta_alm(ID almid, RELTIM almtim)
{
	...
	p_almcb = get_almcb(almid);
	CHECK_NOEXS(p_almcb->p_alminib->almatr);
