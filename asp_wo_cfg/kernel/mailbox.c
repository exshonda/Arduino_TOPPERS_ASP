 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: mailbox.c 49 2012-09-06 04:41:53Z ertl-hiro $
 */
 ...
 *  トレースログマクロのデフォルト定義
 */
#ifndef LOG_CRE_MBX_ENTER
#define LOG_CRE_MBX_ENTER(mbxid, pk_cmbx)
#endif /* LOG_CRE_MBX_ENTER */

#ifndef LOG_CRE_MBX_LEAVE
#define LOG_CRE_MBX_LEAVE(ercd)
#endif /* LOG_CRE_MBX_LEAVE */
...
snd_mbx(ID mbxid, T_MSG *pk_msg)
{
	...
	CHECK_MBXID(mbxid);
	p_mbxcb = get_mbxcb(mbxid);
	CHECK_NOEXS(p_mbxcb->p_mbxinib->mbxatr);
