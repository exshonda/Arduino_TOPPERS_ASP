 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: allfunc.h 49 2012-09-06 04:41:53Z ertl-hiro $
 */
...
#define TOPPERS_att_isr
#define TOPPERS_intini
#define TOPPERS_cfg_int
#define TOPPERS_def_inh
