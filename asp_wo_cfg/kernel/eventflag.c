 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: eventflag.c 49 2012-09-06 04:41:53Z ertl-hiro $
 */
 ...
 *  トレースログマクロのデフォルト定義
 */
#ifndef LOG_CRE_FLG_ENTER
#define LOG_CRE_FLG_ENTER(flgid, pk_cflg)
#endif /* LOG_CRE_FLG_ENTER */

#ifndef LOG_CRE_FLG_LEAVE
#define LOG_CRE_FLG_LEAVE(ercd)
#endif /* LOG_CRE_FLG_LEAVE */
...
set_flg(ID flgid, FLGPTN setptn)
{
	...
	CHECK_FLGID(flgid);
	p_flgcb = get_flgcb(flgid);
	CHECK_NOEXS(p_flgcb->p_flginib->flgatr);
