 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: exception.h 49 2012-09-06 04:41:53Z ertl-hiro $
 */
 ...
 */
extern EXCINIB	excinib_table[];

/*
 *  CPU例外ハンドラ番号からCPU例外ハンドラ初期化ブロックを取り出すため
 *  のマクロ
 */
#define get_excinib(excno)	(&(excinib_table[INDEX_EXCNO(excno)]))
