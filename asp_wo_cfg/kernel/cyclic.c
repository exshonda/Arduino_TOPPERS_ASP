 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: cyclic.c 49 2012-09-06 04:41:53Z ertl-hiro $
 */
...
#ifndef LOG_CRE_CYC_ENTER
#define LOG_CRE_CYC_ENTER(cycid, pk_ccyc)
#endif /* LOG_CRE_CYC_ENTER */

#ifndef LOG_CRE_CYC_LEAVE
#define LOG_CRE_CYC_LEAVE(ercd)
#endif /* LOG_CRE_CYC_LEAVE */
...
sta_cyc(ID cycid)
{
	...
	CHECK_CYCID(cycid);
	p_cyccb = get_cyccb(cycid);
	CHECK_NOEXS(p_cyccb->p_cycinib->cycatr);
