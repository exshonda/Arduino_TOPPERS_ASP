 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: mempfix.c 74 2014-04-20 18:14:21Z ertl-hiro $
 */
 ...
 *  トレースログマクロのデフォルト定義
 */
#ifndef LOG_CRE_MPF_ENTER
#define LOG_CRE_MPF_ENTER(mpfid, pk_cmpf)
#endif /* LOG_CRE_MPF_ENTER */

#ifndef LOG_CRE_MPF_LEAVE
#define LOG_CRE_MPF_LEAVE(ercd)
#endif /* LOG_CRE_MPF_LEAVE */
...
get_mpf(ID mpfid, void **p_blk)
{
	...
	CHECK_MPFID(mpfid);
	p_mpfcb = get_mpfcb(mpfid);
	CHECK_NOEXS(p_mpfcb->p_mpfinib->mpfatr);
